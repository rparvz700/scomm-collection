...
class MonthlySummaryController extends Controller
{
    ...
    private function columns(): array
    {
        $columns = [
            ...
            ['key' => 'total_opening_os_postpaid', 'label' => 'Total Opening OS Postpaid', 'type' => 'money', 'readOnly' => true],
            ['key' => 'total_opening_os_prepaid', 'label' => 'Total Opening OS Prepaid', 'type' => 'money', 'readOnly' => true],
            ...
            ['key' => 'total_mrc', 'label' => 'Total MRC', 'type' => 'money', 'readOnly' => true],
            ['key' => 'total_mrc_postpaid', 'label' => 'Total MRC Postpaid', 'type' => 'money', 'readOnly' => true],
            ['key' => 'total_mrc_prepaid', 'label' => 'Total MRC Prepaid', 'type' => 'money', 'readOnly' => true],
            ...
            ['key' => 'net_backlog_postpaid', 'label' => 'Net Backlog Postpaid', 'type' => 'money', 'readOnly' => true],
            ['key' => 'net_backlog_prepaid', 'label' => 'Net Backlog Prepaid', 'type' => 'money', 'readOnly' => true],
            ['key' => 'net_backlog_total', 'label' => 'Net Backlog Total', 'type' => 'money', 'readOnly' => true],
            ['key' => 'backlog_postpaid_nttn', 'label' => 'Backlog Postpaid NTTN', 'type' => 'money'],
            ['key' => 'backlog_postpaid_iig_nttn', 'label' => 'Backlog Postpaid IIG NTTN', 'type' => 'money'],
            ['key' => 'backlog_postpaid_iig', 'label' => 'Backlog Postpaid IIG', 'type' => 'money'],
            ['key' => 'backlog_postpaid_itc', 'label' => 'Backlog Postpaid ITC', 'type' => 'money'],
            ['key' => 'backlog_postpaid_nix', 'label' => 'Backlog Postpaid NIX', 'type' => 'money'],
            ['key' => 'backlog_prepaid_nttn', 'label' => 'Backlog Prepaid NTTN', 'type' => 'money'],
            ['key' => 'backlog_prepaid_iig_nttn', 'label' => 'Backlog Prepaid IIG NTTN', 'type' => 'money'],
            ['key' => 'backlog_prepaid_iig', 'label' => 'Backlog Prepaid IIG', 'type' => 'money'],
            ['key' => 'backlog_prepaid_itc', 'label' => 'Backlog Prepaid ITC', 'type' => 'money'],
            ['key' => 'backlog_prepaid_nix', 'label' => 'Backlog Prepaid NIX', 'type' => 'money'],
            ...
            ['key' => 'latest_os_postpaid_nttn', 'label' => 'Latest OS Postpaid NTTN', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_postpaid_iig_nttn', 'label' => 'Latest OS Postpaid IIG NTTN', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_postpaid_iig', 'label' => 'Latest OS Postpaid IIG', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_postpaid_itc', 'label' => 'Latest OS Postpaid ITC', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_postpaid_nix', 'label' => 'Latest OS Postpaid NIX', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_prepaid_nttn', 'label' => 'Latest OS Prepaid NTTN', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_prepaid_iig_nttn', 'label' => 'Latest OS Prepaid IIG NTTN', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_prepaid_iig', 'label' => 'Latest OS Prepaid IIG', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_prepaid_itc', 'label' => 'Latest OS Prepaid ITC', 'type' => 'money', 'readOnly' => true],
            ['key' => 'latest_os_prepaid_nix', 'label' => 'Latest OS Prepaid NIX', 'type' => 'money', 'readOnly' => true],
    ...
    private function moneyColumns(): array
    {
        return [
             ...
             'total_opening_os',
             'total_opening_os_postpaid',
             'total_opening_os_prepaid',
             'mrc_postpaid_nttn',
             'mrc_postpaid_nttn_iig',
             'mrc_postpaid_iig',
             'mrc_postpaid_itc',
             ...
             'net_backlog_prepaid',
             'net_backlog_total',
             'backlog_postpaid_nttn',
             'backlog_postpaid_iig_nttn',
             'backlog_postpaid_iig',
             'backlog_postpaid_itc',
             'backlog_postpaid_nix',
             'backlog_prepaid_nttn',
             'backlog_prepaid_iig_nttn',
             'backlog_prepaid_iig',
             'backlog_prepaid_itc',
             'backlog_prepaid_nix',
             ...
             'total_latest_os',
             'latest_os_postpaid_nttn',
             'latest_os_postpaid_iig_nttn',
             'latest_os_postpaid_iig',
             'latest_os_postpaid_itc',
             'latest_os_postpaid_nix',
             'latest_os_prepaid_nttn',
             'latest_os_prepaid_iig_nttn',
             'latest_os_prepaid_iig',
             'latest_os_prepaid_itc',
             'latest_os_prepaid_nix',
             'pdc',
             'udc',
             'expired_chq',
             'nttn_tds_amount',
