    ...
    <div class="slides-track" id="slidesTrack">
        ...
        <section class="dashboard-slide">
            ...
            @if(isset($combinedRiskBreakdown['rows']))
                ...
                <article class="panel">
                    <div class="panel-header">
                        <h2>ISP, IIG & Other Client's {{ $currentMonthLabel }} OS Summary</h2>
                        ...
                        <tbody>
                            @foreach($combinedRiskBreakdown['rows'] as $row)
                                @php
                                    ...
                                    $textStyle = '';
                                    $barColor = '#3b82f6';
                                    if ($row['category'] === 'Best' || $row['category'] === 'Good') {
                                        $bgStyle = 'background-color: #e0f2fe !important;';
                                        $barColor = '#10b981';
                                    } elseif ($row['category'] === 'Moderate') {
                                        $bgStyle = 'background-color: #fef3c7 !important;';
                                        $barColor = '#f59e0b';
                                    } elseif ($row['category'] === 'Risky') {
                                        $bgStyle = 'background-color: #ffedd5 !important;';
                                        $barColor = '#f97316';
                                    } elseif ($row['category'] === 'High Risky') {
                                        $bgStyle = 'background-color: #fed7aa !important;';
                                        $barColor = '#f43f5e';
